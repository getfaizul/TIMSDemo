...
public class TIAS_number_generator {
...
driver.switchTo().frame("fullscreen-app-host");// Switch By iframe name

//Thread.sleep(10000);
//Click on Sandwich icon

//driver.findElement(By.xpath("//*[text()='Documents Metadata']")).click();
//driver.findElement(By.cssSelector("[appmagic-control=\"TIMSNumberTextInputtextarea\"]")).sendKeys("Test Title");
driver.findElement(By.cssSelector("[data-shortcut-id=\"1\"]")).click();
Thread.sleep(2000);

// Click on "Modules" option
driver.findElement(By.xpath("//*[text()='Modules ▼']")).click();
Thread.sleep(2000);

// Click on "TIF Publication" option
driver.findElement(By.xpath("//*[text()='TIF Publication']")).click();
Thread.sleep(2000);
 
// Verify the "TIF Publication" page opens
driver.findElement(By.xpath("//*[text()='TIAS Number Generator']")).isDisplayed();  // Add Assertion
Thread.sleep(2000);

// Enter TIMS Number
driver.findElement(By.cssSelector("[appmagic-control=\"TIMSSearchInputLabeltextbox\"]")).sendKeys("1204");
Thread.sleep(2000);

// Click on the plus icon
driver.findElement(By.cssSelector("[data-shortcut-id=\"38\"]")).click();
Thread.sleep(2000);

// Click on the view icon
driver.findElement(By.cssSelector("[title=\"View Data\"]")).click();
Thread.sleep(5000);


// verify the Date
driver.findElement(By.xpath("//*[text()='Records Matched: 1']")).isDisplayed(); // Add Assertion
Thread.sleep(2000);
